...
# see: https://github.com/bunkerity/bunkerweb/pull/1602
    ...
    def get_reports(self, _id: Optional[int] = None) -> List[dict[str, Any]]:
        if _id:
            ...
            try:
                ...
                self._logger.warning(f"Yacine debugging..")
                self._logger.warning(f"Getting the reporst: {instance.reports()}")
            except:
                return []
            if not resp:
                return []
        ...
        self._logger.warning(f"Second condition..")
        ...
        self._logger.warning(f"Last check..")
